...
$string['email_teachercancelled_subject'] = '{$a->course_short}: Appointment cancelled by the Admin';
...
has been cancelled. Please apply for a new slot. Reason - {$a->reason_cancel}';
...
<p><strong><span class="error">has been cancelled</span></strong>. Please apply for a new slot. <strong>Reason - {$a->reason_cancel}</strong></p>';
